    ...
    <div class="col-lg-12">
      <div class="row">
        <div class="col-lg-12 text-left">
          <base-button class="btn-link" @click="back()"
      ...
      <div class="row">
        <div class="col-lg text-center">
          <base-checkbox v-model="a"
            ><img :src="one" width="258" height="270"
          /></base-checkbox>
          <br />
          <br />
        ...
        <div class="col-lg text-center">
          <base-checkbox v-model="b"
            ><img :src="two" width="258" height="270"
          /></base-checkbox>
          <br />
          <br />
          <p style="font-size: 28px">Tandas Berbau</p>
        </div>
        <div class="col-lg text-center">
          <base-checkbox v-model="c"
            ><img :src="three" width="258" height="270"
          /></base-checkbox>
          <br />
          <br />
          <p style="font-size: 28px">
        ...
        <div class="col-lg text-center">
          <base-checkbox v-model="d"
            ><img :src="four" width="258" height="270"
          /></base-checkbox>
          <br />
          <br />
          <p style="font-size: 28px">
